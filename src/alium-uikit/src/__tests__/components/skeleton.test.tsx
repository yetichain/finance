...
it('renders correctly', () => {
  ...
  expect(asFragment()).toMatchInlineSnapshot(`
    ...
    .c1 {
      -webkit-animation: hDWTUO 2s infinite ease-out;
      animation: hDWTUO 2s infinite ease-out;
...
it('renders correctly waves animation', () => {
  ...
  expect(asFragment()).toMatchInlineSnapshot(`
    ...
    .c1:before {
      ...
      height: 100%;
      width: 150px;
      -webkit-animation: bGJpRH 2s cubic-bezier(0.4,0,0.2,1) infinite;
      animation: bGJpRH 2s cubic-bezier(0.4,0,0.2,1) infinite;
    }
